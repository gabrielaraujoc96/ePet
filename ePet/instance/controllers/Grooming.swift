...
class Grooming:Product{
    ...
    init(productType: String, description: String, descriptionProduct: String, technicalInf: String, costValue:Double,valueSell:Double,lifestage:String,breaedSize:String){
